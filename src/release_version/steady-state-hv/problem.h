...
///////////////////////////////////////wfg problems...
void wfg1(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG1( X, k, M );
}
void wfg2(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG2( X, k, M );
}
void wfg3(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG3( X, k, M );
}
void wfg4(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG4( X, k, M );
}
void wfg5(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG5( X, k, M );
}
void wfg6(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG6( X, k, M );
}
void wfg7(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG7( X, k, M );
}
void wfg8(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
        F = Problems::WFG8( X, k, M );
}
void wfg9(std::vector<double> &F, std::vector<double> &X, int &k)
{
	int M = F.size();
